...
class GitlabCheck(GenericPrometheusCheck):
    """
    ...
    def _create_gitlab_prometheus_instance(self, instance, init_config):
        """
        Set up the gitlab instance so it can be used in GenericPrometheusCheck
        """
    ...
    def _check_health_endpoint(self, instance, check_type, tags):
        ...
        try:
            ...
            self.service_check(service_check_name, GenericPrometheusCheck.OK, tags=service_check_tags)
