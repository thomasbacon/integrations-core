...
from datadog_checks.checks.prometheus import PrometheusFormat, UnknownFormatError
import requests
...
class PrometheusMultiScraperMixin(object):
    ...
    def __init__(self, *args, **kwargs):
        ...
        super(PrometheusMultiScraperMixin, self).__init__(*args, **kwargs)
    ...
    def get_metric_value_by_labels(messages, _metric, _m, metric_suffix):
        ...
        expected_labels = set([(k, v) for k, v in iteritems(_metric["labels"])
                               if k not in PrometheusMultiScraperMixin.UNWANTED_LABELS])
